...
def process_train_data(setting):
    ...
    np.save('./data/npy/nlpcc2016_train_word.npy',train_word)
    np.save('./data/npy/nlpcc2016_train_label.npy',train_label)
    np.save('./data/npy/nlpcc2016_train_length.npy', train_length)
...
def process_test_data(setting):
    ...
    np.save('./data/npy/nlpcc2016_test_word.npy',test_word)
    np.save('./data/npy/nlpcc2016_test_label.npy',test_label)
    np.save('./data/npy/nlpcc2016_test_length.npy', test_length)
...
def preprocess(filename):
    ...
    np.save('./data/npy/nlpcc2016_cws_word.npy', sentence)
    np.save('./data/npy/nlpcc2016_cws_label.npy', label)
    np.save('./data/npy/nlpcc2016_cws_length.npy', length)
...
np.save('./data/npy/nlpcc2016_vector.npy',vector)
