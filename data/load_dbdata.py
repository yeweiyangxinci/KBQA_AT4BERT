...
def create_db():
    ...
    sql = """create table nlpccQA(entity LongText character set utf8 collate utf8_unicode_ci,
    attribute LongText character set utf8 collate utf8_unicode_ci, answer LongText character set utf8 
